...
//*------------------------использование классов для карточе-------------------------
    ...
    const getResource = async (url) => { // т.к.только получаем данные, то и объект с настройками не нужен
    ...
    // getResource('http://localhost:3000/menu') //вариант динамического создания контента
